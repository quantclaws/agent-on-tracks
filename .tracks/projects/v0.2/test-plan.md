...
| AC-0601..0607（thread 结构 + identity 无持久化/全文扫描/重排/回滚/L3 报告） | unit + ground_truth | test_discuss_parser.py, test_discuss_locate.py |
...
| AC-1501..1505（trac validate/outcome 即校验/门禁再校验） | unit + e2e | test_validate.py, test_validation_gate.py |
