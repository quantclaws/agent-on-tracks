...
def git_repo(tmp_path, *, gitignore=False, email="test@example.com", name="Test"):
...
def ev(seq, type, payload=None, run_id="RUN", version="v0.1", command_id=None, task_id=None):
...
def capture_popen_cmd(monkeypatch, target="tracks.effects.opencode.subprocess.Popen"):
...
BASELINE_CMD = (
    "command.issued",
    {"command": {"kind": "freeze_baseline", "params": {"stage": "M-IMPL"}, "command_id": "C1"}},
)
...
ARCHER_DISPATCH = (
    "command.issued",
    {
        "command": {
            "kind": "dispatch_agent",
            "params": {"role": "archer", "substate": "PLANNING"},
            "command_id": "C2",
        }
    },
)
...
TASKGRAPH_CMD = (
    "command.issued",
    {"command": {"kind": "commit_taskgraph", "params": {"stage": "M-IMPL"}, "command_id": "C3"}},
)
TASKGRAPH_COMMITTED = ("taskgraph.committed", {"task_count": 1})
ISLAND1_CMD = (
    "command.issued",
    {"command": {"kind": "check_island_1", "params": {"stage": "M-IMPL"}, "command_id": "C4"}},
)
...
PRISM_PLAN_DISPATCH = (
    "command.issued",
    {
        "command": {
            "kind": "dispatch_agent",
            "params": {"role": "prism", "substate": "PRISM_PLAN"},
            "command_id": "C5",
        }
    },
)
...
SELECT_TASK_CMD = (
    "command.issued",
    {"command": {"kind": "select_task", "params": {"stage": "M-IMPL"}, "command_id": "C6"}},
)
...
DEVON_RED_DISPATCH = (
    "command.issued",
    {
        "command": {
            "kind": "dispatch_agent",
            "params": {"role": "devon", "substate": "RED"},
            "command_id": "C7",
        }
    },
)
...
RED_GATE_CMD = (
    "command.issued",
    {
        "command": {
            "kind": "run_task_gates",
            "params": {"stage": "M-IMPL", "gate": "RED_GATE"},
            "command_id": "C8",
        }
    },
)
...
PRISM_RED_DISPATCH = (
    "command.issued",
    {
        "command": {
            "kind": "dispatch_agent",
            "params": {"role": "prism", "substate": "PRISM_RED"},
            "command_id": "C10",
        }
    },
)
...
DEVON_GREEN_DISPATCH = (
    "command.issued",
    {
        "command": {
            "kind": "dispatch_agent",
            "params": {"role": "devon", "substate": "GREEN"},
            "command_id": "C11",
        }
    },
)
...
GREEN_GATE_CMD = (
    "command.issued",
    {
        "command": {
            "kind": "run_task_gates",
            "params": {"stage": "M-IMPL", "gate": "GREEN_GATE"},
            "command_id": "C12",
        }
    },
)
...
def m_impl_store(repo: Path, *, design_checkpoint: bool = True) -> Store:
    ...
    if design_checkpoint:
        ...
        store.append(
            ...
            "v0.5",
            "result.checkpointed",
            {"created_commit": True, "commit_sha": sha, "base_sha": sha, "result_id": "D1"},
        )
